...
exports.UpdateSomeTable1727249466771 = void 0;
class UpdateSomeTable1727249466771 {
    constructor() {
        this.name = 'UpdateSomeTable1727249466771';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE \`key_token\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` int NOT NULL, \`accessKey\` varchar(255) NOT NULL, \`refreshKey\` varchar(255) NOT NULL, \`refreshToken\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TABLE \`key_token\``);
            yield queryRunner.query(`DROP TABLE \`UserAdvance\``);
        });
    }
}
exports.UpdateSomeTable1727249466771 = UpdateSomeTable1727249466771;
//# sourceMappingURL=1727249466771-update_some_table.js.map